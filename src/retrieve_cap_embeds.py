...
def main(): 
    ...
    print('Filtering captions')    # filtered captions that are too long (> 25 tokens)
    ...
    print('Writing files')
    faiss.write_index(index, "datastore/{}_index".format(args.dataset))
    json.dump(captions, open('datastore/{}_index_captions.json'.format(args.dataset), 'w'))

    json.dump(retrieved_caps, open('data/{}_retrieved_caps_resnet50x64.json'.format(args.dataset), 'w'))
