...
class SmallCap(PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        kwargs_encoder = {argument: value for argument, value in kwargs.items() if not argument.startswith("decoder_") and not argument.startswith("ret_")}

        kwargs_decoder = {
            argument[len("decoder_") :]: value for argument, value in kwargs.items() if argument.startswith("decoder_") or argument.startswith("ret_")
        }
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        irrelevant_prefix = ["decoder_", "cross_attn", "use_cache", "ret_"]
        encoder_kwargs = {
            argument: value
