...
if __name__ == '__main__':
    ...
    ## order
    parser.add_argument("--order", type=str, default="default", choices=['default', 'sample', 'permute', 'reverse', 'topk_reverse', 'c-samplek'], 
                        help="order sensitivity, choices from ['default', 'sample', 'permute', 'reverse', 'topk_reverse', 'c-samplek']")
